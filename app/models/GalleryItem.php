...
class GalleryItem extends Model
{
    ...
    {
        $query = "INSERT INTO {$this->table_name} SET name = :name, dimensions = :dimensions, material = :material, color = :color, weight = :weight, price = :price, status = :status, description = :description, showing_on_site = :showing_on_site, created_by = :created_by";
        $stmt = $this->con->prepare($query);
